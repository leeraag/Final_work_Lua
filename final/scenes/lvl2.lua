...
local function spawnBomb ()
  local bomb = display.newImageRect("images/broken-heart.png", 70, 60)
  ...
  spawnBomb_timer = timer.performWithDelay (350, spawnBomb, 0)
  ...
  spawnPlus_timer = timer.performWithDelay (1100, spawnPlus, 0)
  ...
  spawnPlus5_timer = timer.performWithDelay (5100,spawnPlus5, 0)
  ...
  spawnHeal_timer = timer.performWithDelay (7100,spawnHeal, 0)

--игрок
local player = display.newImage(sceneGroup, tst2, 100, 470)
player.height = h
player.width = w
